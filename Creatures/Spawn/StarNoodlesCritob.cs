...
sealed class StarNoodlesCritob : Critob
{

    public StarNoodlesCritob() : base(Enums.CreatureTemplateType.StarNoodles)
    {
        LoadedPerformanceCost = 20f;
        SandboxPerformanceCost = new(linear: 0.6f, exponential: 0.1f);
        ShelterDanger = ShelterDanger.Safe;
        CreatureName = "StarNoodles";
    ...
    {
        Relationships self = new(Enums.CreatureTemplateType.StarNoodles);
    ...
    {
        return new StarNoodle(acrit, acrit.world);
    }
    ...
    {
        yield return "StarNoodles";
        yield return "SNoodles";
    }
