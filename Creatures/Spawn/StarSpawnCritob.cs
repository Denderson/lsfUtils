...
sealed class StarSpawnCritob : Critob
{

    public StarSpawnCritob() : base(Enums.CreatureTemplateType.StarSpawn)
    {
        LoadedPerformanceCost = 20f;
        SandboxPerformanceCost = new(linear: 0.6f, exponential: 0.1f);
        ShelterDanger = ShelterDanger.Safe;
        CreatureName = "StarSpawn";
    ...
    public override void EstablishRelationships()
    {
        ...
        Relationships self = new(Enums.CreatureTemplateType.StarSpawn);
    ...
    {
        return new StarSpawn(acrit, acrit.world);
    }
