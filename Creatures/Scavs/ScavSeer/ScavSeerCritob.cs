...
namespace lsfUtils.Creatures.Scavs.ScavSeer
{
    ...
    public class ScavSeerCritob : Critob
    {

        public ScavSeerCritob() : base(Enums.CreatureTemplateType.ScavSeer)
        {
            ...
            RegisterUnlock(KillScore.Configurable(1), Enums.SandboxUnlockID.ScavSeer, MultiplayerUnlocks.SandboxUnlockID.Slugcat);
        }
        ...
        public override string DevtoolsMapName(AbstractCreature acrit) => "ScSc";

        public override IEnumerable<string> WorldFileAliases() => ["scavSeer", "scavengerSeer"];
        public override CreatureTemplate CreateTemplate()
        {
            CreatureTemplate creatureTemplate = new CreatureFormula(CreatureTemplate.Type.Scavenger, Type, "ScavSeer")
            {
        ...
        public override Creature CreateRealizedCreature(AbstractCreature acrit) => new lsfUtils.Creatures.Scavs.ScavSeer.ScavSeer(acrit, acrit.world);
