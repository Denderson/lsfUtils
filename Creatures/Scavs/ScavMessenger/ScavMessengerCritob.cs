...
namespace lsfUtils.Creatures.Scavs.ScavMessenger
{
    ...
    public class ScavMessengerCritob : Critob
    {

        public ScavMessengerCritob() : base(Enums.CreatureTemplateType.ScavMessenger)
        {
            ...
            RegisterUnlock(KillScore.Configurable(1), Enums.SandboxUnlockID.ScavMessenger, MultiplayerUnlocks.SandboxUnlockID.Slugcat);
        }
        ...
        public override IEnumerable<string> WorldFileAliases() => new string[] { "scavMessenger", "scavengerMessenger" };
        public override CreatureTemplate CreateTemplate()
        {
            CreatureTemplate creatureTemplate = new CreatureFormula(CreatureTemplate.Type.Scavenger, Type, "ScavMessenger")
            {
        ...
        public override Creature CreateRealizedCreature(AbstractCreature acrit) => new ScavMessenger(acrit, acrit.world);
